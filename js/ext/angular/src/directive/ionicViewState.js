  ...
  return {
    ...
    compile: function(tElement, tAttrs) {
      ...
      return function link($scope, $element, $attr) {
        ...
        var unregisterTitleUpdated = $rootScope.$on('viewState.titleUpdated', function(e, data) {
        ...
        $scope.$on('viewState.showBackButton', function(e, data) {
          $scope.backButtonEnabled = !!data;
        });

        $scope.$on('$destroy', unregisterTitleUpdated);
  ...
  return {
    ...
    compile: function(tElement, tAttrs, transclude) {
      ...
      return function link($scope, $element, $attr) {
        ...
        var offShowNavBar = $rootScope.$broadcast('viewState.showNavBar', ($scope.hideNavBar !== 'true') );
        ...
        $scope.$on('$destroy', offShowNavBar);
      };
    }
  };
}])
